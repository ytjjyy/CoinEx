...
<section class="content">
    ...
    <div class="status">
            <span class="status_span">
                ...
                <span style="display: inline-block;vertical-align: middle">挂单监控{{ empty($config['tradeListDetail']) ? '' : $config['tradeListDetail'] }}</span>
            </span>
    </div>
    <div class="status">
            <span class="status_span">
    ...
    <div class="status">
            <span class="status_span">
                ...
                <span style="display: inline-block;vertical-align: middle">高频交易监控{{ empty($config['hfTradeListDetail']) ? '' : $config['hfTradeListDetail'] }}</span>
            </span>
    </div>
    <div class="status">
            <span class="status_span">
    ...
    <div class="status">
            <span class="status_span">
                ...
                <span style="display: inline-block;vertical-align: middle">在线人数:{{empty($config['onlieNumber']) ? 0 : $config['onlieNumber'] }} </span>
            </span>
    </div>

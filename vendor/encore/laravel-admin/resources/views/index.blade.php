...
{{--<div style="display: none">--}}
    {{--<audio src="{{ asset('video/e2ab7ded085d10e6943edc0a21761a31.mp3') }}", controls="controls" autoplay loop></audio>--}}
{{--</div>--}}
<div class="wrapper">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">拨币</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">币种配置</label>
                    <select name="coin" id="coinName" class="form-control" class="coinName">
                        <option value="">请选择</option>

                        @if(getCoin())
                            @foreach(getCoin() as $item)
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">信用金</label>
                    <input type="text" class="form-control" id="available" placeholder="信用金" class="available">
                    <input type="hidden" name="merchant_id" class="merchant_id">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">保证金</label>
                    <input type="text" class="form-control" id="freeze" placeholder="保证金" class="freeze">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary add-coin">确认</button>
            </div>
        </div>
    </div>
</div>

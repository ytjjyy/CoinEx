...
class SpecialAccountHandlerController extends Controller
{
    use ModelForm;
    ...
    {
        request()->offsetSet('noWarningType','TIME_MONITORING_TRADE');
        return Admin::content(function (Content $content) {

            $content->header('特殊账号处理');
            $content->description('特殊账号处理');
    ...
    public function edit($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            $content->header('修改特殊账号');
            $content->description('修改特殊账号');
    ...
    public function create()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header('添加特殊账号');
            $content->description('添加特殊账号');
    ...
    protected function form()
    {
        return Admin::form(SpecialAccountHandler::class, function (Form $form) {
            ...
            $form->hidden('noWarningType','类型')->default('TIME_MONITORING_TRADE');
